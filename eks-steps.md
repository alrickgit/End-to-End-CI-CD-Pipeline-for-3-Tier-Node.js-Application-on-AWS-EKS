...
```bash
aws eks --region ap-south-1 update-kubeconfig --name three-tier-app
```
...
aws iam attach-role-policy \
    --policy-arn arn:aws:iam::<AccountID>:policy/AmazonEKS_EBS_CSI_Driver_Policy \
    --role-name eksctl-three-tier-app-nodegroup-ng-NodeInstanceRole-a3CrX049wVn4
```
